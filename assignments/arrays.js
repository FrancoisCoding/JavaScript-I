...
for(var i = 0; i < inventory.length; i++){
    var models = inventory[i].car_model;
...
let carYears = [];
for(var i = 0; i < inventory.length; i++){
    var years = inventory[i].car_year;
    carYears.push(years);
}
...
let BMWAndAudi = [];
for(var i = 0; i < inventory.length; i++){
    var make = inventory[i];
    if (make.car_make.includes("BMW") || make.car_make.includes("Audi")) {
